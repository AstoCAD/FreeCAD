    ...
    def migrationScript7(self, joint):
        ...
        def migrate_prop(prop_name, add_method, assembly):
            ...
            if old_ref:
                ...
                old_subs = old_ref[1]
                if old_subs:
                    comp, first_new_sub = UtilsAssembly.getComponentReference(assembly, root, old_subs[0])
    ...
    def handleInitialSelection(self):
        ...
        for sel in selection:
            ...
            for sub_name in sel.SubElementNames:
                ...
                comp, new_sub = UtilsAssembly.getComponentReference(self.assembly, sel.Object, sub_name)
                if not comp:
                    break
