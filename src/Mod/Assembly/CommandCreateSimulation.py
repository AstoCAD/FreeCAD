...
class TaskAssemblyCreateSimulation(QtCore.QObject):
    ...
    def saveAnimation(self):
        ...
        # 1. Prompt user for file location and type
        ...
        # 4. Setup temporary directory and progress bar
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            try:
                # 5. Generate and save all frames as temporary images
                frame_files = []
                ...
                # 6. Assemble the final animation file
