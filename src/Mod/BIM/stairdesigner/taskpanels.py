...
class StairDesignerTaskPanel:
    ...
    def _make_stringer_panel(self):
        ...
        self.stringer_tree.setToolTip(
            translate(
                "BIM",
                "Choose the stringer type independently for each flight side.",
            )
        )
        ...
        stringer_help = {
            ...
            self.stringer_width: translate(
                "BIM",
                "Board width. Disable Custom width to calculate it from the stair geometry.",
            ),
        ...
        self.stringer_custom_width.setToolTip(
            translate(
                "BIM",
                "Enable to enter a fixed board width instead of using the automatic width.",
            )
        )
    ...
    def _make_handrail_panel(self):
        ...
        self.handrail_tree.setToolTip(
            translate(
                "BIM",
                "Enable a handrail independently on the left or right side of each flight.",
            )
        )
        ...
        general_help = {
            self.handrail_height: translate(
                "BIM",
                "Vertical distance from the tread nosing line to the top of the top rail. Verify the height required by the applicable building code.",
            ),
            ...
            self.handrail_picket_spacing: translate(
                "BIM",
                "Maximum clear opening between pickets. Common targets are 100 mm in UK/European practice and 4 in (102 mm) under the US IRC; verify the applicable local code.",
            ),
        }
