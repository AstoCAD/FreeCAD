...
class StairProxy:
    ...
    def set_properties(self, obj):
        ...
        _add_property(
            ...
            "RisersEnabled",
            "Risers",
            QT_TRANSLATE_NOOP("App::Property", "Create individual wooden risers"),
            True,
        )
        _add_property(
            obj,
        ...
        _add_property(
            ...
            "PriorityToRiser",
            "Risers",
            QT_TRANSLATE_NOOP("App::Property", "Give the riser priority at tread intersections"),
            False,
        )
        _add_property(
            obj,
        ...
        _add_property(
            ...
            "Stringers",
            QT_TRANSLATE_NOOP(
                "App::Property", "Use a manually specified stringer width"
            ),
            False,
        )
        _add_property(
